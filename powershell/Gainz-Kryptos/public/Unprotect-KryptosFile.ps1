function Unprotect-KryptosFile()
{
    Param(
        [Alias("s")]
    ...
    if((Test-Path $dest) -and !$Force.ToBool()) {
        Write-Warning "Destination file already exists: $dest"
        Write-Warning "Use -Force to overwrite the file"
    }
